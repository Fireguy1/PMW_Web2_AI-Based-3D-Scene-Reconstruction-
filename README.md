...
* **Why?** HeriTeq uses artificial intelligence to organize memories and preserve stories in a meaningful way.

### Secondary Theme: Youth Culture Archive
This theme focuses on storytelling, memories, and human experiences.
* **Why?** HeriTeq aims to preserve not only information but also the people and emotions behind those memories.
...
### Team Name
* **HeriTeq** (Heritage + Technology)

### Tagline
* _Preserving Memories, Nurturing Minds._

### Logo Direction
* **Infinity Loop with Hidden H.**
* **Meaning:** The infinity loop represents:
  * Continuity
  * Memory
  * Human connection
  * Growth
...
### Age Demographic
* **Primary Audience:** 18–35 years
* **Secondary Audience:** 35–55 years

### Ideal Customer Profiles (ICPs)

#### 👔 Ideal Customer Profile 1: Young Professionals
* **Age:** 22–35
...
* **Online Behavior:** LinkedIn, Instagram, YouTube

#### 🎓 Ideal Customer Profile 2: University Students
* **Age:** 18–25
* **Motivations:**
  * Explore AI technologies.
  * Learn about cultural heritage.
  * Document family traditions.
* **Platforms:** Instagram, LinkedIn, GitHub

#### 📜 Ideal Customer Profile 3: Heritage Enthusiasts
* **Age:** 30–55
* **Motivations:**
...
* **Preservation:** Every story deserves to be remembered.
* **Privacy:** Users maintain ownership and control over their memories and information.
* **Cultural Respect:** Every culture, tradition, and voice matters.
* **Accessibility:** Memory preservation should be available to everyone.
* **Authenticity:** Technology should strengthen human connections, not replace them.

---

## 🗣️ Brand Voice & Aesthetics
...
| :--- | :--- | :--- |
| **Primary Teal** | `#146C94` | Represents trust and clarity. |
| **Emerald Green** | `#2D6A4F` | Represents growth and preservation. |
| **Ivory White** | `#F8FAFC` | Represents openness and simplicity. |
| **Slate** | `#1E293B` | Used for structure and primary text. |
| **Muted Gray** | `#64748B` | Used for supporting content. |

### 🔤 Typography
* **Headings:** `font-family: "Space Grotesk", sans-serif;`
* **Body:** `font-family: "Inter", sans-serif;`
* **Accent (Used for quotes and storytelling):** `font-family: "Playfair Display", serif;`
...
### LinkedIn Bio
> AI-powered memory companion preserving stories, traditions, and experiences for future generations. Preserving Memories, Nurturing Minds.
